---
title: "Análise de Sobrevivência com Censura Intervalar para Grandes Bancos de Dados"
author: "Sofia M. de Aguiar"
editor: visual
---

Este script é fruto do Trabalho de Conclusão de Curso em Estatística pela UFMG, defendido em janeiro de 2025 sob orientação do professor Enrico Colosimo.
...
Criamos um conjunto de dados sintético com 12.000 indivíduos e algumas variáveis de interesse, como uma variável categórica (por exemplo, sexo), uma variável contínua (por exemplo, peso ao nascer) e o tempo até a ocorrência do evento de interesse. A construção dos dados leva em consideração a influência das variáveis na probabilidade de o evento ocorrer.
